       ...
       <input name="profile_image" class="form-control" type="file"  id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img id="showImage" class="rounded avatar-lg" src="{{(!empty($editData->image_url))? url('upload/admin_images/'.$editData->image_url): url('upload/no_image.jpg')}}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
